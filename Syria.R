...
my_data <- read_excel("/Users/priya/Desktop/XN /Data/Syria.xlsx")

df_ma <- read_excel("/Users/priya/Desktop/XN /Data/Syria.xlsx")
head(df_ma)
...
df_ma1$Short.term.debt..percent.of.total.external.debt <- 			as.numeric(df_ma1$Short.term.debt..percent.of.total.external.debt)
