...
my_data <- read_excel("/Users/priya/Desktop/XN /Data/Kyz.xlsx")

df_ma <- read_excel("/Users/priya/Desktop/XN /Data/Kyz.xlsx")
head(df_ma)
...
df_ma1$External.debts <- 						as.numeric(df_ma1$External.debts)
...
df_ma1$Liquid.liabilities..percent.of.GDP <- 			as.numeric(df_ma1$Liquid.liabilities..percent.of.GDP)
